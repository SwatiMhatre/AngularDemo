...
export class CreatePaymentComponent implements OnInit {
  ...
  constructor(private  creditAcService:  CreditAcService, private paymentListService: PaymentList, private parserFormatter: NgbDateParserFormatter, formBuilder: FormBuilder) { 
